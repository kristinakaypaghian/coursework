...
#define TX_POWER            (7)
#define UDP_SEND_PORT_STR   "8808" // why does it have to be a string  //TODO
#define UDP_RX_PORT         "8850"      //TODO

// TODO: do we need to declare mutex variable as a global variable?
...
#define RELAY_NODE_ADDR     "fe80::212:4b00:18e0:ba41" //"TO:DO" //TODO
...
int main(void)
{
    ...
    while(1)
    {
        ...
        // Sample ADC with period Tsamp = 2 seconds 
        sample = adc_sample(ADC_LINE(ADC_LINE_SELECT), ADC_RES); // TODO: not redeclare with int?
        char data_string[20];
        sprintf(data_string, "kaypaghi/light: %4d", sample);

        
        xtimer_usleep(2000000);


        // For every ADC sample, send raw sample value to RN via UDP packet with destination port 8808 
        udp_send(RELAY_NODE_ADDR,UDP_SEND_PORT_STR,data_string); // TODO: make these arguments pointers?
